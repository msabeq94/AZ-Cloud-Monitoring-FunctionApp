# i want to get all the resources in the resource group that has the name vf-core-cm-storage-account-availability and "type": "Microsoft.Insights/scheduledQueryRules"
...
"@
 ...
 try {
  ...
  $functionURI ="https://management.azure.com/subscriptions/f5980816-b478-413b-ae0b-5fb6d820a88f/resourceGroups/vf-core-uk-resources-rg/providers/Microsoft.Web/sites/mos49/functions/storage-account-availability?api-version=2015-08-01"
